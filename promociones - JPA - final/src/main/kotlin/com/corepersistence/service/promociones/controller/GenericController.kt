...
import com.corepersistence.service.promociones.service.PopulateDBService
...
/*    @Value("classpath:/data.json")
    ...
    @Autowired
    private lateinit var populateDBService: PopulateDBService
    ...
    fun getObject(){
        ...
        populateDBService.populateDataBase(objeto)
